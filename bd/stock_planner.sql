...
--
-- Host: 127.0.0.1
-- Generation Time: 06-Jul-2019 às 20:31
...
(2, 'lais-mr', '202cb962ac59075b964b07152d234b70', 'Laís Magalhães Rosa', 'lais.magalhaes13@gmail.com', '2019-07-01 15:20:12', '2019-06-06 14:27:33', 1),
...
ALTER TABLE `produtos`
  ADD PRIMARY KEY (`id`),
  ADD KEY `categoria_id_categoria` (`categoria`);
...
--
ALTER TABLE `produtos`
  ADD CONSTRAINT `categoria_id_categoria` FOREIGN KEY (`categoria`) REFERENCES `categoria` (`id`) ON DELETE NO ACTION ON UPDATE CASCADE;
